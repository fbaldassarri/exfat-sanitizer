...
# Backup with Versioning using exfat-sanitizer v12.1.4
...
echo "  ✅ Fixed inverted character classification logic"
echo "  ✅ NFD→NFC normalization (no false renames on macOS)"
echo ""
